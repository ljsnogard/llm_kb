...
> **2026-09-19 14:35 修订**：本节最初只把草稿做成"对话区显示「新会话」"，侧边栏里
> 看不到任何变化，用户点完按钮会觉得没反应。现已改为**在工作区下渲染一条「新会话」
> 草稿行**（内部状态是"未同步"，没有会话 ID），点它即可切回该草稿，悬停可以放弃。
> 实现见 [`kb_admin_desktop-20260919-1435.md`](kb_admin_desktop-20260919-1435.md) §2。
